#
# Shiny App for Variant Alert! exploration
#
library(tidyverse)
library(lubridate)
library(shiny)
...
# col_types = cols(reclassification_status = col_integer())
# Pre processing clinvar files
#clinvar_variant$date <- gsub("\\.vcf\\.gz", "", clinvar_variant$name_clinvar_new )
#clinvar_variant$date  <- gsub("clinvar_", "", clinvar_variant$name_clinvar_new )
           ...
           tabPanel("Home",
            ...
            tabPanel("Compare variants",
                ...
                fluidRow(
                    ...
                    column(4,
                           dateRangeInput("dates_cv", h3("Date range"),start="2017-10-16",min="2017-05-16")),
                    column(8,
            ...
            tabPanel("Compare genes",
                ...
                fluidRow(
                    ...
                    column(4,
                           dateRangeInput("dates_cg", h3("Date range"),start="2017-10-16",min="2017-05-16")),
                    column(8,
